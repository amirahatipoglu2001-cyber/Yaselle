...
export const quickCategories = [
  { href: "/shop/yeni-koleksiyon", image: media.dress, label: { en: "New collection", tr: "Yeni Koleksiyon" } },
...
export const products: Product[] = [
  {
    ...
    materials: ["wool", "silk"],
    collection: "new",
    images: [media.abaya, media.abayaAlt, media.fabric],
  ...
  },
  {
    ...
    collection: "new",
    images: [media.tunic, media.fabric, media.set],
    tags: ["new", "modest"],
    soldCount: 94,
  ...
  },
  {
    ...
    images: [media.jacket, media.fabric, media.abayaAlt],
  ...
  },
  {
    ...
    materials: ["wool"],
    collection: "essentials",
    images: [media.pants, media.fabric, media.tunic],
    tags: ["modest"],
    soldCount: 122,
  ...
  },
  {
    ...
    materials: ["cupro"],
    collection: "new",
    images: [media.set, media.tunic, media.pants],
  ...
  },
  {
    ...
    materials: ["cotton"],
    collection: "essentials",
    images: [media.sweat, media.fabric, media.tunic],
    tags: ["modest", "sale"],
    soldCount: 203,
  ...
  },
  {
    ...
    materials: ["wool"],
    collection: "essentials",
    images: [media.skirt, media.fabric, media.pants],
    tags: ["modest"],
    soldCount: 58,
  ...
  },
  {
    ...
    materials: ["silk"],
    collection: "new",
    images: [media.dress, media.fabric, media.abiye],
    tags: ["new", "custom"],
    soldCount: 61,
  ...
  },
  {
    ...
    materials: ["silk"],
    collection: "evening",
    images: [media.abiye, media.fabric, media.dress],
  ...
  },
  {
    ...
    materials: ["cotton"],
    collection: "essentials",
    images: [media.shirt, media.fabric, media.jacket],
    tags: ["sale"],
    soldCount: 170,
  ...
  },
  {
    ...
    materials: ["silk"],
    collection: "essentials",
    images: [media.blouse, media.fabric, media.dress],
    tags: [],
    soldCount: 73,
  ...
  },
  {
    ...
    materials: ["acetate"],
    collection: "essentials",
    images: [media.skirt, media.fabric, media.shirt],
    tags: [],
    soldCount: 99,
  ...
  },
  {
    ...
    materials: ["silk"],
    collection: "essentials",
    images: [media.scarf, media.fabric, media.abayaAlt],
    tags: [],
    soldCount: 156,
  ...
  },
  {
    ...
    materials: ["linen"],
    collection: "new",
    images: [media.beach, media.linen, media.tunic],
    tags: ["new"],
    soldCount: 44,
