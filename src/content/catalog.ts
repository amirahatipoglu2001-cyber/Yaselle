...
export const products: Product[] = [
  ...
  },
  {
    ...
    related: ["tunic-sand", "shirt-modest"],
    completeTheLook: ["shirt-modest", "shoes-sling"],
  },
  {
    id: "shirt-modest",
    slug: "column-modest-shirt",
    name: { en: "Column Modest Shirt", tr: "Sütun Tesettür Gömlek" },
    summary: { en: "A covered shirt with a closed placket and a modest line.", tr: "Kapalı patlı, ölçülü çizgide bir tesettür gömlek." },
    details: { en: "Long sleeve, covered buttons, and a hem that sits over trousers without riding up.", tr: "Uzun kol, kapalı düğmeler ve pantolon üzerine oturan etek ucu." },
    fit: { en: "Easy through the torso. Hip 110 cm in M.", tr: "Gövde rahat. M bedende kalça 110 cm." },
    fabric: { en: "Washed cotton-silk.", tr: "Yıkanmış pamuk-ipek." },
    care: { en: "Gentle wash 30°C. Hang dry.", tr: "30°C hassas yıkama. Askıda kurutun." },
    category: "tesettur",
    subcategory: "gomlek",
    alsoIn: ["yeni-koleksiyon"],
    priceTry: 4290,
    colors: [{ id: "wine", name: { en: "Wine", tr: "Şarap" }, hex: "#7A2430" }],
    sizes,
    stock: { XS: 5, S: 7, M: 6, L: 5, XL: 3 },
    materials: ["cotton", "silk"],
    collection: "new",
    images: [media.eveningRed, media.scarf, media.tunic],
    tags: ["new", "modest"],
    soldCount: 54,
    createdAt: "2026-09-08",
    related: ["blouse-modest", "tunic-sand"],
    completeTheLook: ["pants-column", "scarf-dune"],
  },
  {
    id: "blouse-modest",
    slug: "lace-modest-blouse",
    name: { en: "Lace Modest Blouse", tr: "Dantel Tesettür Bluz" },
    summary: { en: "A blouse with lace that still covers.", tr: "Danteli olan, yine de örten bir bluz." },
    details: { en: "High neck, long sleeve, and a hem meant to sit over a skirt or trousers.", tr: "Yüksek yaka, uzun kol; etek veya pantolon üzerine oturan etek ucu." },
    fit: { en: "True to size. Length 78 cm in M.", tr: "Bedenine sadık. M bedende boy 78 cm." },
    fabric: { en: "Cotton lace over viscose.", tr: "Viskon üzerine pamuk dantel." },
    care: { en: "Hand wash cold. Dry flat.", tr: "Soğuk elde yıkayın. Sererek kurutun." },
    category: "tesettur",
    subcategory: "bluz",
    priceTry: 5190,
    colors: [{ id: "sage", name: { en: "Sage", tr: "Adaçayı" }, hex: "#6B7F5C" }],
    sizes,
    stock: { XS: 4, S: 6, M: 5, L: 4, XL: 2 },
    materials: ["cotton", "viscose"],
    collection: "essentials",
    images: [media.hijabEditorial, media.hijabLace, media.tunic],
    tags: ["modest", "bestseller"],
    soldCount: 81,
    createdAt: "2026-07-22",
    related: ["shirt-modest", "skirt-modest"],
    completeTheLook: ["skirt-modest", "scarf-dune"],
  },
  {
    id: "dress-ivory",
